...
from src import task_orm, task_model, task_query_model
...
class TaskService:
    ...
    def get_task_by_query_model(self, query_model: task_query_model.TaskQueryModel):
        query_model.set_finish_date(
            self.convert_string_to_datetime(query_model.get_finish_date())
        )
    ...
    def save_task(self, task_model: task_model.TaskModel):
        task_model.set_date(self.convert_string_to_datetime(task_model.get_date()))
